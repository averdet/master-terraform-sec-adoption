...
INPUT_FILE = "csv/dataset-tfsec.csv"
...
with open(INPUT_FILE, 'r') as f:
    ...
    for repo_name in tqdm(to_visit_repo):
        ...
        if not visited_repo.get(repo_name, False):
            ...
            commit_hash_study = get_closest_commit(PATH_OF_TMP_DIRECTORY + repo_name, datetime(2022, 10, 13))
            if commit_hash_study is not None:
