...
INPUT_FILE = "./csv/google_dataset_filtered-tfsec.csv"
...
with open(INPUT_FILE, 'r') as f:
    ...
    repo_name_list = [repo.split(',')[0].replace("\n","") for repo in repo_list]
    ...
    for repo_name in tqdm(to_visit_repo):
        ...
        if not visited_repo.get(repo_name, False):
            ...
            commit_hash_study = get_closest_commit(PATH_OF_TMP_DIRECTORY + repo_name, datetime(2023, 4, 26))
